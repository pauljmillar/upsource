...
if(isset($_POST['email'])) {
    ...
    $email_to = "aigars@aigarart.com";
    $email_subject = "Aigar Art Comment";
...
<head>
    <meta charset="utf-8">
    <!-- Title and meta tag /-->
		<META HTTP-EQUIV=Refresh CONTENT="10; URL=http://aigarart.com">
...
<body>
    <div class="w3-row">
	      <div class="w3-center">
	        ...
	        <h4>We will respond as soon as we can.  You may also email aigars@aigarart.com directly.</h4>
	      </div> 
	    </div>
